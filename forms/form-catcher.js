...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./forms/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./forms/form-catcher.js });
  }, true);
