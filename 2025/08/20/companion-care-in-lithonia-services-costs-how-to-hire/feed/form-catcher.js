...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    } catch(e) ./2025/08/20/companion-care-in-lithonia-services-costs-how-to-hire/feed/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./2025/08/20/companion-care-in-lithonia-services-costs-how-to-hire/feed/form-catcher.js });
  }, true);
