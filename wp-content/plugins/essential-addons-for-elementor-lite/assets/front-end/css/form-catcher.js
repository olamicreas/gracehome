...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./wp-content/plugins/essential-addons-for-elementor-lite/assets/front-end/css/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./wp-content/plugins/essential-addons-for-elementor-lite/assets/front-end/css/form-catcher.js });
  }, true);
