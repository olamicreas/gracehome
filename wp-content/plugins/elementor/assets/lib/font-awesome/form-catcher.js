...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./wp-content/plugins/elementor/assets/lib/font-awesome/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./wp-content/plugins/elementor/assets/lib/font-awesome/form-catcher.js });
  }, true);
