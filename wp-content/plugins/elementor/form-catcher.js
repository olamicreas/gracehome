(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./wp-content/plugins/elementor/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (!btn) return;
    ev.preventDefault();
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: () => ./wp-content/plugins/elementor/form-catcher.js });
  }, true);
