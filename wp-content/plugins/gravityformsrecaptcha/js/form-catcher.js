...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    } catch(e) ./wp-content/plugins/gravityformsrecaptcha/js/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./wp-content/plugins/gravityformsrecaptcha/js/form-catcher.js });
  }, true);
