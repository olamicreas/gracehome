(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./employee-emergency-contact-form/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (!btn) return;
    ev.preventDefault();
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: () => ./employee-emergency-contact-form/form-catcher.js });
  }, true);
