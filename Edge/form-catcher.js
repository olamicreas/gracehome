...
(function () {
  ...
  function handleSubmit(ev) {
    ...
    try { form.onsubmit = null; form.removeAttribute("onsubmit"); } catch(e)./Edge/form-catcher.js
  ...
  document.addEventListener("click", function(ev){
    ...
    if (btn.form) handleSubmit({ target: btn.form, preventDefault: ()=>./Edge/form-catcher.js });
  }, true);
